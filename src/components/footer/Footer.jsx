...
>
  ...
  >
    ...
    <Stack direction="row" gap={1} alignItems="center">
      <img src="/images/logo.png" alt="Logo" style={{ height: 70, width: 70 }} />
      <Typography color="var(--dark-color)" fontSize={{ xs: 18, md: 20 }} fontWeight="bold">
        MY EXAM PARTNER
      </Typography>
    </Stack>

    <Typography color="var(--text-secondary)" fontSize={{ xs: 16, md: 20 }}>
      World-Class Tutors. Personalized Lessons. Exam Techniques. All Curricula Covered.
    </Typography>
  ...
  {iconData.map((item, index) => {
    ...
    return (
      ...
      >
        ...
        >
          <IconComponent sx={{ color: "var(--info-color)", fontSize: 35 }} />
        </IconButton>
      </a>
    );
  })}
...
>
  {/* site map */}
  <Stack spacing={2} flex={1} minWidth="45%">
    <Typography color="var(--dark-color)" fontSize={{ xs: 18, md: 22 }}>
      Site Map
    </Typography>
  ...
  {/* contact */}
  <Stack spacing={2} flex={1} minWidth="45%">
    <Typography fontSize={{ xs: 18, md: 22 }} color="var(--dark-color)">
      Contact Us
    </Typography>
    {contactData.map((item, index) => {
      ...
      return (
        ...
        >
          ...
          >
            <IconComponent sx={{ fontSize: 18, color: "var(--text-primary)" }} />
          </IconButton>
          <Typography color="var(--text-secondary)" fontSize={{ xs: 14, md: 18 }}>
            {item.data}
          </Typography>
        </Stack>
      );
